    ...
    <footer className="bg-black pt-24 pb-12 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-16 mb-16">
          <div className="flex flex-col">
            <div className="flex items-center gap-2 mb-8">
              <div className="w-10 h-10 bg-[#0072d2] rounded-full flex items-center justify-center shadow-lg shadow-blue-600/10">
                <span className="font-black text-xl italic text-white">H</span>
              </div>
          ...
          <div className="grid grid-cols-2 gap-8">
            <div>
              <h4 className="font-bold uppercase tracking-widest text-xs mb-8 text-white">Navegação</h4>
              <ul className="space-y-4 text-sm text-white/50">
                <li><a href="#services" className="hover:text-white transition-colors">Nossos Serviços</a></li>
                <li><a href="#about" className="hover:text-white transition-colors">Sobre o QG</a></li>
                <li><a href="#feedbacks" className="hover:text-white transition-colors">Depoimentos</a></li>
                <li><a href="#booking" className="hover:text-white transition-colors">Agendamentos</a></li>
              </ul>
            </div>
            <div>
              <h4 className="font-bold uppercase tracking-widest text-xs mb-8 text-white">Suporte</h4>
              <ul className="space-y-4 text-sm text-white/50">
                <li><a href="https://wa.me/5531999044206" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Contato Direto</a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] text-white/30 font-bold uppercase tracking-[0.2em]">
          <p className="text-center md:text-left">© 2024 O Herói da Cidade. Todos os direitos reservados.</p>
          <p className="text-center md:text-right">Desenvolvido com tecnologia Stark</p>
        </div>
      </div>
    </footer>
  );
